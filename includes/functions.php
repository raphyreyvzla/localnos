...
function siteURL() {
  global $db, $settings;
  $protocol = ((!empty($_SERVER['HTTP']) && $_SERVER['HTTP'] != 'off') || 
    $_SERVER['SERVER_PORT'] == 443) ? "https://" : "https://";
...
function getIcon($name,$width,$height) {
	...
	elseif($name == "Banano") { $icon = 'Banano.png'; }
	elseif($name == "Nos") { $icon = 'nosnollar2.png'; }
  elseif($name == "Nollar") { $icon = 'nosnollar.png'; }
  elseif($name == "Bank Transfer VES") { $icon = 'venezuela.png'; }
	elseif($name == "Nano") { $icon = 'Nano.png'; }
