...
if($b == "add") {
	?>
	<ol class="breadcrumb">
		<li><a href="./">LocalNos Administrator</a></li>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
            ...
            <option value="Nos">Banano</option>
            <option value="Nollar">Nollar</option>
						...
						<option value="Bank Transfer VES">Bank Transfer VES</option>
				...
				<div class="form-group">
					<label>Currency</label>
                                ...
                                <option value="NOS">NOS - Nos</option>                                                                                                                                                                                                    <option value="NOLLAR">USD - Nollar</option>
											...
											<option value="VES">VES - Venezuela Bolivar Soberano</option>
	...
	?>
	<ol class="breadcrumb">
		<li><a href="./">Local Nos P2P Administrator</a></li>
		<li><a href="./?a=gateways">Gateways</a></li>
			...
			<form action="" method="POST">
				...
				<div id="account_fields">
					...
					if($gateway == "PayPal") {
						...
						?>
						<div class="form-group">
							<label>Your Nano address</label>
							<input type="text" class="form-control" name="a_field_1" value="<?php echo $row['a_field_1']; ?>">
						</div>
						<?php
					} elseif($gateway == "Banano") {
						?>
						<div class="form-group">
							<label>Your Banano address</label>
							<input type="text" class="form-control" name="a_field_1" value="<?php echo $row['a_field_1']; ?>">
						</div>
						<?php
          } elseif($gateway == "Nos") {
						?>
						<div class="form-group">
							<label>Your Nos address</label>
							<input type="text" class="form-control" name="a_field_1" value="<?php echo $row['a_field_1']; ?>">
						</div>
						<?php
          } elseif($gateway == "Nollar") {
						?>
						<div class="form-group">
							<label>Your Nollar address</label>
							<input type="text" class="form-control" name="a_field_1" value="<?php echo $row['a_field_1']; ?>">
						</div>
						<?php
						...
						<?php
					} elseif($gateway == "Bank Transfer VES") {
						?>
						
				<div class="form-group">
					<label>Seleccione un Banco</label>
					<select class="form-control" name="selectbankvzla">
						<option value="BDV">Banco de Venezuela</option>
						<option value="Mercantil">Mercantil</option>
						<option value="Banesco">Banesco</option>
						<option value="BOD">Banco Occidentak del Descuento</option>
						...
						<option value="Caroni">Bano Caroni</option>
						<option value="Activo">Activo</option>
						<option value="Venezolano">Venezolano de Credito</option>
						<option value="Tesoro">Banco del Tesoro</option>
						<option value="BANFAB">Banco de La Fuerza Armada Nacional Bolivariana</option>
							</select>
					</div>
						</br>
						<div class="form-group">
						<label>Tipo de Cuenta</label>
			<select class="form-control" name="typeaccountve">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="a_field_2" value="<?php echo $row['a_field_1']; ?>">
						</div>
						<div class="form-group">
							<label>Numero de Cuenta</label>
							<input type="text" class="form-control" name="a_field_3" value="<?php echo $row['a_field_2']; ?>">
						</div>
						<div class="form-group">
							<label>Cedula de Identidad</label>
							<input type="text" class="form-control" name="a_field_4" value="<?php echo $row['a_field_3']; ?>">
						</div>
...
?>
<ol class="breadcrumb">
	<li><a href="./">Junglex Administrator</a></li>
