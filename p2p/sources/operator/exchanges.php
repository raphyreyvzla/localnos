...
if($b == "explore") {
	...
	<ol class="breadcrumb">
		...
		<li><a href="./?a=exchanges">Intercambios</a></li>
		<li class="active">Busqueda de ID</li>
	</ol>
...
<ol class="breadcrumb">
	<li><a href="./">LocalNOS Venezuela - Operador P2P</a></li>
	<li class="active">Intercambios Pendientes</li>
</ol>
		...
		<table class="table table-striped">
			...
			<tbody>
				...
				if($searching==1) {
					...
					$query = $db->query("SELECT * FROM {$statement} WHERE status='3' ORDER BY id DESC LIMIT {$startpoint} , {$limit}");
				}
				if($query->num_rows>0) {
