		...
		$html_form = '<div id="bit_exchange_results"></div>
			<div class="row">
				...
				<div class="col-md-8">
					...
					<form id="bit_exchange_form">
					<div class="form-group">
					<label for="bit_u_field_8">Seleccione un Banco:</label>
						
					<select class="form-control" name="bit_u_field_8">
						<option value="Banco de Venezuela">Banco de Venezuela</option>
						<option value="Mercantil">Mercantil</option>
						<option value="Banesco">Banesco</option>
						<option value="Banco Occidentak del Descuent">Banco Occidentak del Descuento</option>
						<option value="Provinciall">Provincial</option>
					...
					<div class="form-group">
				<label for="bit_u_field_9">Tipo de Cuenta Bancaria:</label>
						
					<select class="form-control" name="bit_u_field_9">
