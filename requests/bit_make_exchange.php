...
if($query->num_rows>0) {	
	...
	if($gateway_send == "Bank Transfer VES") {
	?>
	<div class="row">
	...
	<?php
	} elseif($gateway_send == "Xoomwallet" or $gateway_send == "Neteller" or $gateway_send == "Nollar" or $gateway_send == "Nos" or $gateway_send == "Banano" or $gateway_send == "UQUID" or $gateway_send == "Yandex Money" or $gateway_send == "QIWI" or $gateway_send == "BTC-e" or $gateway_send == "2checkout") {
	?>
	<div class="row">
		<div class="col-md-2"></div>
		<div class="col-md-8">
