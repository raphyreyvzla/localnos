			...
			<div class="ad-profile section">	
					<div class="user-profile">
						<div class="user">
							...
							<h5>Ultimo acceso al sistema : <?php echo date("d F Y H:i",idinfo($_SESSION['bit_uid'],"last_login")); ?></h5>
						</div>

						<div class="favorites-user">
							<div class="my-ads">
								<a href="#"><?php $nums = $db->query("SELECT * FROM bit_exchanges WHERE uid='$_SESSION[bit_uid]'"); echo $nums->num_rows; ?><small>Exchanges</small></a>
							</div>
						</div>								
					</div><!-- user-profile -->
					...
					<ul class="user-menu">
						<li><a href="<?php echo $settings['url']; ?>account/exchanges"><i class="fa fa-refresh"></i> <?php echo $lang['my_exchanges']; ?></a></li>
                               <li><a href="<?php echo $settings['url']; ?>account/p2pmain"><i class="fa fa-users"></i> <?php echo $lang['p2pmain']; ?></a></li>
