...
<a href="<?php echo $settings['url']; ?>account/verification" class="btn btn-primary btn-sm" > <i class="fa fa-users"></i><?php echo $lang['p2pkycverify']; ?></a> 
<?php } ?>
<?php if(idinfo($_SESSION['bit_uid'],"status") == "3") { ?>
<a href="<?php echo $settings['url']; ?>p2p/index.php" class="btn btn-primary btn-sm"><?php echo $lang['accessp2p']; ?></a> 
<?php } ?>
</span></center>
</br>
</br>
...
if($b == "explore") {
	...
	<div class="row">
		...
		$account_data = '<tr>
							...
							?>
								<tr>
								<td><span class="pull-left">Entidad Bancaria del Cliente</span></td>
								<td><span class="pull-right"><?php echo $row['u_field_8']; ?></span></td>
								</tr>
									<tr>
								<td><span class="pull-left">Tipo de Cuenta</span></td>
								<td><span class="pull-right"><?php echo $row['u_field_9']; ?></span></td>
								</tr>
							<tr>
							...
							<tr>
								<td><span class="pull-left">Cuenta Bancaria del Cliente</span></td>
								<td><span class="pull-right"><?php echo $row['u_field_5']; ?></span></td>
								</tr>
						
							<tr>
								<td><span class="pull-left">Cedula de Identidad del Cliente</span></td>
...
<div class="panel panel-default">
	<div class="panel-heading">
		Explorador de Intercambios
		<span class="pull-right">
			<form action="" method="POST">
			<h3>	<input type="text" class="input_search" name="qry" placeholder="Buscar Transaccion..."></h3>
			</form>
	...
	<div class="panel-body">
      ...
      <thead>
				<tr>
					...
					<th width="20%">Hacia</th>
					<th width="20%">Monto a recibir</th>
					<th width="15%">Intercambio ID</th>
				...
				if($query->num_rows>0) {
					while($row = $query->fetch_assoc()) {
						...
						<tr>
							...
							<td><span class="label label-default"><?php echo $row['u_field_8']; ?></span></td>
							<td>
								<?php
										if($row['status'] == "1") {
											echo '<span class="label label-warning"><i class="fa fa-clock-o"></i> Esperando Confirmacion</span>';
										} elseif($row['status'] == "2") {
											echo '<span class="label label-warning"><i class="fa fa-clock-o"></i> Esperando Pago</span>';
										} elseif($row['status'] == "3") {
											echo '<span class="label label-info"><i class="fa fa-clock-o"></i> En Curso</span>';
										} elseif($row['status'] == "4") {
											echo '<span class="label label-success"><i class="fa fa-check"></i> Completado</span>';
										} elseif($row['status'] == "5") {
											echo '<span class="label label-danger"><i class="fa fa-times"></i> Vencido</span>';
										} elseif($row['status'] == "6") {
											echo '<span class="label label-danger"><i class="fa fa-times"></i> Denegado</span>';
										} elseif($row['status'] == "7") {
											echo '<span class="label label-danger"><i class="fa fa-times"></i> Cancelado</span>';
										} else {
